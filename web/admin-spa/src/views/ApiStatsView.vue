    ...
    >
      <div class="flex flex-col items-center justify-between gap-3 sm:gap-4 md:flex-row">
        ...
        <div class="flex items-center gap-2 md:gap-4">
          ...
          <div
            v-if="
              oemSettings.googleOAuthEnabled ||
              oemSettings.userManagementEnabled ||
              oemSettings.showAdminButton !== false
            "
            class="h-8 w-px bg-gradient-to-b from-transparent via-gray-300 to-transparent opacity-50 dark:via-gray-600"
          />

          <!-- 用户登录按钮 (仅在 Google OAuth2 启用时显示) -->
          <router-link
            v-if="oemSettings.googleOAuthEnabled"
